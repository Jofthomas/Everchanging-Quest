...
def game_over_screen(WINDOW,event,music):
    ...
    # Load the images
    base_image = pygame.image.load('graphics/UI/Game Over/Game_over.png')
    animation_images = import_folder('graphics/UI/Game Over/death')
    running = True
    music.play()
    while running:
